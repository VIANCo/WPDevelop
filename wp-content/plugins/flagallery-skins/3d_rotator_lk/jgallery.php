...
.grandRotatorAlternative { clear: both; width: <?php echo $width; if(strpos($width, '%') === false) echo 'px'; ?>; height: <?php echo $height; ?>px; overflow: hidden; }
.grandRotatorAlternative > div { display: none; position: relative; width: 100%; }
.grandRotatorAlternative div img { width: 100%; max-width: 100%; height: auto; }
.grandRotatorAlternative > div:first-child { display: block; }
.grandRotatorAlternative a { display: block; width: <?php echo $width; if(strpos($width, '%') === false) echo 'px'; ?>; height: <?php echo $height; ?>px; overflow: hidden; }
.grandRotatorAlternative span { display: block; position: absolute; left: 0px; top: 10px; padding: 5px 10px; background: #000000; color: #ffffff; font-size: 12px; }
.grandRotatorAlternative span strong { font-size: 14px; margin-bottom: 3px; }
</style>
...
jQuery(document).ready(function() {
	...
	if(fv.major<9){	
		...
		jQuery('#<?php echo $skinID; ?>_jq .grandRotatorAlternative').cycle({
...
<div id="<?php echo $skinID; ?>_jq"><div class="grandRotatorAlternative">
<?php 
